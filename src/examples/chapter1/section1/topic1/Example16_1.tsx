...
function Example16_1() {
  const [v1, setV1] = useState<THREE.Vector3>(new THREE.Vector3(1.0, 0.0, -1.0));
  const [v2, setV2] = useState<THREE.Vector3>(new THREE.Vector3(-1.0, 0.0, -2.0));
