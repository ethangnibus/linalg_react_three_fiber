...
function Example16() {
  return (
    <div className="border-2">
          <H2 className="p-2 bg-gradient-to-r from-zinc-600 dark:from-slate-300 to-zinc-200 dark:to-slate-800 text-white dark:text-black">Example 16</H2>
          <div className="p-2">
          ...
          <Accordion type="single" collapsible className="w-full border-2 pb-2 mt-4 px-2 bg-secondary">
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-sky-900">Solution</AccordionTrigger>
